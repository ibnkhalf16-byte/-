              ...
              children: [
                pw.Column(
                  ...
                  children: [
                    ...
                    pw.Text('الطرف: ${person.name}', style: const pw.TextStyle(fontSize: 14)),
                ...
                pw.Column(
                  ...
                  children: [
                    ...
                    pw.Text('تاريخ التقرير: ${DateTime.now().toString().substring(0, 10)}', style: const pw.TextStyle(fontSize: 10, color: PdfColors.grey700)),
                  ],
                ),
              ],
            ),
